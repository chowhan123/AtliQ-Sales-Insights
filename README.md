...
2. Download the SQL database file: [Database\_Dataset.sql](./Database_Dataset.sql) (https://github.com/chowhan123/AtliQ-Sales-Insights/blob/main/Database%20DataSet.sql).
